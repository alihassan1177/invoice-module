                ...
                <div class="card-body">
                    <form action="{{ route('taxes.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input required maxlength="256" value="{{ old('tax_percentage') }}" placeholder="Enter Tax Percentage" type="number" class="form-control" name="tax_percentage" id="tax_percentage">
                            @error('name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
