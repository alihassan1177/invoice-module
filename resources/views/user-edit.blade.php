                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="account_no" type="text" class="form-control @error('text') is-invalid @enderror" name="account_no" value="{{ old('account_no', $user->account_no) }}" placeholder="Enter account no or CIN number" required>
                                        <div class="help-block with-errors" ></div>
